...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_flipt_react_native_fn_clone_fliptclient(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_flipt_react_native_fn_free_fliptclient(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ...
  ubrn_uniffi_flipt_react_native_fn_method_fliptclient_close(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_batch(
    ptr: bigint,
    requests: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_boolean(
    ptr: bigint,
    request: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_variant(
    ptr: bigint,
    request: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ...
  ubrn_uniffi_flipt_react_native_fn_method_fliptclient_test_client(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ...
  ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_test_client(): number;
  ubrn_uniffi_flipt_react_native_checksum_constructor_fliptclient_new(): number;
  ubrn_ffi_flipt_react_native_uniffi_contract_version(): number;
...
// Casting globalThis to any allows us to look for `NativeFliptReactNative`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeFliptReactNative` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeFliptReactNative;

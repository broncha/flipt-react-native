  ...
  implements FliptClientInterface
{
  ...
  refresh(previousHash: string | undefined): boolean /*throws*/ {
...
const uniffiTypeFliptClientObjectFactory: UniffiObjectFactory<FliptClientInterface> =
  (() => {
    return {
      create(pointer: UniffiHandle): FliptClientInterface {
      ...
      pointer(obj: FliptClientInterface): UniffiHandle {
      ...
      clonePointer(obj: FliptClientInterface): UniffiHandle {

  ...
  implements FliptClientInterface
{
   ...
   * Simple test method to verify the client is working
   */
  public testClient(): string {
    return FfiConverterString.lift(
      uniffiCaller.rustCall(
        /*caller:*/ (callStatus) => {
          return nativeModule().ubrn_uniffi_flipt_react_native_fn_method_fliptclient_test_client(
            uniffiTypeFliptClientObjectFactory.clonePointer(this),
            callStatus
          );
        },
...
function uniffiEnsureInitialized() {
  ...
  if (
    nativeModule().ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_test_client() !==
    33429
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(

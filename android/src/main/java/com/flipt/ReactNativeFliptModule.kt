...
@ReactModule(name = ReactNativeFliptModule.NAME)
class ReactNativeFliptModule(reactContext: ReactApplicationContext) :
  NativeReactNativeFliptSpec(reactContext) {
  ...
  // broncha-react-native-flipt.cpp
  ...
  companion object {
    const val NAME = "ReactNativeFlipt"

    init {
      System.loadLibrary("broncha-react-native-flipt")
    }
  }
}
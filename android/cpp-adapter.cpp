...
// Automated testing checks Java_com_flipt_ReactNativeFliptModule and broncha_reactnativeflipt
// by comparing the whole line here.
/*
Java_com_flipt_ReactNativeFliptModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return broncha_reactnativeflipt::multiply(a, b);
}
*/

// Installer coming from ReactNativeFliptModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_flipt_ReactNativeFliptModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return broncha_reactnativeflipt::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_flipt_ReactNativeFliptModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return broncha_reactnativeflipt::cleanupRustCrate(*runtime);
}
...
// Automated testing checks Java_com_flipt_FliptModule and flipt
// by comparing the whole line here.
/*
Java_com_flipt_FliptModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return flipt::multiply(a, b);
}
*/

// Installer coming from FliptModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_flipt_FliptModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return flipt::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_flipt_FliptModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return flipt::cleanupRustCrate(*runtime);
}
...
impl FliptClient {
    ...
    pub fn new(opts: ClientOptions) -> Result<Self, FliptError> {
        ...
        let engine_ptr = unsafe {
            flipt_engine_ffi::initialize_engine(c_string.into_raw())
        };
    ...
    /// Simple test method to verify the client is working
    pub fn test_client(&self) -> String {
        println!("DEBUG: test_client called on FliptClient instance");
        "FliptClient instance is working".to_string()
    }

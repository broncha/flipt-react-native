...
// it!
#include "flipt_react_native.hpp"
...
void uniffi_flipt_react_native_fn_method_fliptclient_refresh(
    void *ptr, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_flipt_react_native_fn_method_fliptclient_test_client(
    void *ptr, RustCallStatus *uniffi_out_err);
RustBuffer
ffi_flipt_react_native_rustbuffer_alloc(uint64_t size,
                                        RustCallStatus *uniffi_out_err);
RustBuffer
ffi_flipt_react_native_rustbuffer_from_bytes(ForeignBytes bytes,
                                             RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rustbuffer_free(RustBuffer buf,
                                            RustCallStatus *uniffi_out_err);
RustBuffer
ffi_flipt_react_native_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                          RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_flipt_react_native_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_flipt_react_native_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_flipt_react_native_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_flipt_react_native_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_flipt_react_native_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_flipt_react_native_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_flipt_react_native_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_flipt_react_native_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_flipt_react_native_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
...
void ffi_flipt_react_native_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_flipt_react_native_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_flipt_react_native_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_flipt_react_native_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_flipt_react_native_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_flipt_react_native_checksum_method_fliptclient_close();
uint16_t uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_batch();
uint16_t
...
uint16_t uniffi_flipt_react_native_checksum_method_fliptclient_test_client();
uint16_t uniffi_flipt_react_native_checksum_constructor_fliptclient_new();
uint32_t ffi_flipt_react_native_uniffi_contract_version();
}
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::flipt_react_native::Bridging<T>::fromJs(rt, callInvoker,
                                                             pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_flipt_react_native_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_flipt_react_native_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_flipt_react_native_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::flipt_react_native::registry {
...
// Callback function:
// uniffi::flipt_react_native::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// This method is called from the destructor of NativeFliptReactNative, which
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::flipt_react_native::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::flipt_react_native::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::flipt_react_native::cb::rustfuturecontinuationcallback::
...
NativeFliptReactNative::NativeFliptReactNative(
  ...
  props["ubrn_uniffi_flipt_react_native_fn_clone_fliptclient"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_flipt_react_native_fn_clone_fliptclient"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_flipt_react_native_fn_clone_fliptclient(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_fn_free_fliptclient"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_flipt_react_native_fn_free_fliptclient"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_flipt_react_native_fn_free_fliptclient(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_fn_constructor_fliptclient_new"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_flipt_react_native_fn_constructor_fliptclient_new"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_fn_constructor_fliptclient_new(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_close"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_flipt_react_native_fn_method_fliptclient_close"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
  ...
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_batch"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_fn_"
                                        "method_fliptclient_evaluate_batch"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_batch(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_"
        "boolean"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_fn_method_"
                                    "fliptclient_evaluate_boolean"),
      2,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_boolean(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_evaluate_"
        "variant"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_fn_method_"
                                    "fliptclient_evaluate_variant"),
      2,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
  ...
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_refresh"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
          ...
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_fn_method_fliptclient_refresh(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_fn_method_fliptclient_test_client"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_fn_"
                                        "method_fliptclient_test_client"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_fn_method_fliptclient_test_client(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_close"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_"
                                        "checksum_method_fliptclient_close"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
  ...
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_batch(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_"
        "boolean"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_checksum_"
                                    "method_fliptclient_evaluate_boolean"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_boolean(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_evaluate_"
        "variant"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_checksum_"
                                    "method_fliptclient_evaluate_variant"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
  ...
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_list_"
        "flags"] = jsi::Function::createFromHostFunction(
      rt,
      jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_checksum_"
                                    "method_fliptclient_list_flags"),
      0,
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_flipt_react_native_checksum_method_fliptclient_list_flags(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_refresh"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_"
                                        "checksum_method_fliptclient_refresh"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_checksum_method_fliptclient_refresh(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_flipt_react_native_checksum_method_fliptclient_test_"
      ...
      [this](jsi::Runtime &rt, const jsi::Value &thisVal,
             const jsi::Value *args, size_t count) -> jsi::Value {
        return this
            ->cpp_uniffi_flipt_react_native_checksum_method_fliptclient_test_client(
                rt, thisVal, args, count);
      });
  props["ubrn_uniffi_flipt_react_native_checksum_constructor_fliptclient_new"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_flipt_react_native_"
                                        "checksum_constructor_fliptclient_new"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_flipt_react_native_checksum_constructor_fliptclient_new(
                    rt, thisVal, args, count);
          });
  props["ubrn_ffi_flipt_react_native_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_flipt_react_native_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_flipt_react_native_uniffi_contract_version(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_internal_fn_method_fliptclient_ffi__bless_pointer"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_internal_fn_method_fliptclient_ffi__bless_pointer"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_internal_fn_method_fliptclient_ffi__bless_pointer(
                    rt, thisVal, args, count);
          });
}

void NativeFliptReactNative::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeFliptReactNative>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeFliptReactNative", obj);
}

void NativeFliptReactNative::unregisterModule(jsi::Runtime &rt) {
  uniffi::flipt_react_native::registry::clearRegistry();
}

jsi::Value NativeFliptReactNative::get(jsi::Runtime &rt,
...
NativeFliptReactNative::getPropertyNames(jsi::Runtime &rt) {
...
void NativeFliptReactNative::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                                 const jsi::Value &value) {
...
jsi::Value
NativeFliptReactNative::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeFliptReactNative::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeFliptReactNative::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeFliptReactNative::cpp_uniffi_flipt_react_native_fn_clone_fliptclient(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
...
jsi::Value NativeFliptReactNative::
  ...
  RustCallStatus status =
      uniffi::flipt_react_native::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_flipt_react_native_fn_constructor_fliptclient_new(
...
jsi::Value NativeFliptReactNative::
  ...
  RustCallStatus status =
      uniffi::flipt_react_native::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_flipt_react_native_fn_method_fliptclient_test_client(
      uniffi_jsi::Bridging<void *>::fromJs(rt, callInvoker, args[0]), &status);
  uniffi::flipt_react_native::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);
...
jsi::Value NativeFliptReactNative::
    cpp_uniffi_flipt_react_native_checksum_method_fliptclient_close(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_flipt_react_native_checksum_method_fliptclient_close();
...
jsi::Value NativeFliptReactNative::
    cpp_uniffi_flipt_react_native_checksum_method_fliptclient_refresh(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_flipt_react_native_checksum_method_fliptclient_refresh();
...
jsi::Value NativeFliptReactNative::
    cpp_uniffi_flipt_react_native_checksum_method_fliptclient_test_client(
        ...
        size_t count) {
  auto value =
      uniffi_flipt_react_native_checksum_method_fliptclient_test_client();
...
jsi::Value NativeFliptReactNative::
    cpp_uniffi_flipt_react_native_checksum_constructor_fliptclient_new(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_flipt_react_native_checksum_constructor_fliptclient_new();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value
NativeFliptReactNative::cpp_ffi_flipt_react_native_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_flipt_react_native_uniffi_contract_version();
